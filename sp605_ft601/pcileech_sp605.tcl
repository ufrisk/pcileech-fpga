...
set myProject "pcileech_sp605"
set myScript "pcileech_sp605.tcl"
...
proc add_source_files {} {
   ...
   xfile add "ipcore_dir/s6_pcie_v2_4/source/axi_basic_top.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/axi_basic_tx.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/axi_basic_tx_pipeline.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/axi_basic_tx_thrtl_ctl.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/gtpa1_dual_wrapper.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/gtpa1_dual_wrapper_tile.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/pcie_bram_s6.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/pcie_bram_top_s6.v"
   xfile add "ipcore_dir/s6_pcie_v2_4/source/pcie_brams_s6.v"
...
proc set_process_props {} {
   ...
   project set "Output File Name" "pcileech_top" -process "Generate IBIS Model"
