...
set_property IOB TRUE [get_cells i_pcileech_com/i_pcileech_ft601/__d_ft601_rd_n_reg]
set_property IOB TRUE [get_cells i_pcileech_com/i_pcileech_ft601/__d_ft601_oe_n_reg]
set_property IOB TRUE [get_cells i_pcileech_com/i_pcileech_ft601/txo_valid_n_reg]
set_property IOB TRUE [get_cells i_pcileech_com/i_pcileech_ft601/txo_dout_reg[*]]

set_false_path -from [get_pins i_pcileech_com/i_pcileech_ft601/oe_reg/C] -to [get_ports {{ft601_be[*]} {ft601_data[*]} ft601_rd_n ft601_wr_n}]
