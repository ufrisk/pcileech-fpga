...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_pcie_a7_x4.v"]\
 [file normalize "${origin_dir}/src/pcileech_pcie_cfg_a7.v"]\
 [file normalize "${origin_dir}/src/pcileech_pcie_tlp_a7.v"]\
 [file normalize "${origin_dir}/src/pcileech_vfifo_ctl.v" ]\
 [file normalize "${origin_dir}/src/pcileech_ac701_top.v"]\
...
set file "src/pcileech_pcie_a7_x4.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "src/pcileech_vfifo_ctl.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "src/pcileech_ac701_top.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
set_property -name "scoped_to_cells" -value "pcileech_vfifo_mig_7series_0_0" -objects $file_obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/ip/fifo_128x1024_32.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "fifo_128x1024_32/fifo_128x1024_32.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/ip/fifo_128x512_128.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "fifo_128x512_128/fifo_128x512_128.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/ip/fifo_32x16_32.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "fifo_32x16_32/fifo_32x16_32.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
proc cr_bd_pcileech_vfifo { parentCell } {
  ...
  set design_name pcileech_vfifo
...
proc write_mig_file_pcileech_vfifo_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <ModuleName>pcileech_vfifo_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_pcileech_vfifo_mig_7series_0_0()
  ...
  set ui_clk_0 [ create_bd_port -dir O -type clk ui_clk_0 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXIS_0:M_AXIS_0} \
   CONFIG.ASSOCIATED_RESET {aresetn_0} \
 ] $ui_clk_0
  set vfifo_mm2s_channel_full_0 [ create_bd_port -dir I -from 1 -to 0 vfifo_mm2s_channel_full_0 ]
  set vfifo_s2mm_channel_full_0 [ create_bd_port -dir O -from 1 -to 0 vfifo_s2mm_channel_full_0 ]
  ...
  set_property -dict [ list \
   CONFIG.ar_weight_ch0 {4} \
   CONFIG.ar_weight_ch1 {4} \
   CONFIG.axis_tdata_width {128} \
   CONFIG.dram_base_addr {00000000} \
   CONFIG.number_of_page_ch0 {256} \
  ...
  write_mig_file_pcileech_vfifo_mig_7series_0_0 $str_mig_file_path
  ...
  connect_bd_intf_net -intf_net S_AXIS_0_1 [get_bd_intf_ports S_AXIS_0] [get_bd_intf_pins axi_vfifo_ctrl_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_vfifo_ctrl_0_M_AXIS [get_bd_intf_ports M_AXIS_0] [get_bd_intf_pins axi_vfifo_ctrl_0/M_AXIS]
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports DDR3_0] [get_bd_intf_pins mig_7series_0/DDR3]

  # Create port connections
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins axi_vfifo_ctrl_0/aresetn] [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net axi_vfifo_ctrl_0_vfifo_s2mm_channel_full [get_bd_ports vfifo_s2mm_channel_full_0] [get_bd_pins axi_vfifo_ctrl_0/vfifo_s2mm_channel_full]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_ports ui_clk_0] [get_bd_pins axi_vfifo_ctrl_0/aclk] [get_bd_pins mig_7series_0/ui_clk]
  connect_bd_net -net sys_rst_0_1 [get_bd_ports sys_rst_0] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net vfifo_mm2s_channel_full_0_1 [get_bd_ports vfifo_mm2s_channel_full_0] [get_bd_pins axi_vfifo_ctrl_0/vfifo_mm2s_channel_full]

  # Create address segments
  create_bd_addr_seg -range 0x02000000 -offset 0x00000000 [get_bd_addr_spaces axi_vfifo_ctrl_0/Data_S2MM] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
...
# End of cr_bd_pcileech_vfifo()
cr_bd_pcileech_vfifo ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files pcileech_vfifo.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files pcileech_vfifo.bd ] 
set_property IS_ENABLED "1" [get_files pcileech_vfifo.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files pcileech_vfifo.bd ] 
set_property IS_LOCKED "0" [get_files pcileech_vfifo.bd ] 
set_property IS_MANAGED "0" [get_files pcileech_vfifo.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files pcileech_vfifo.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files pcileech_vfifo.bd ] 
set_property PFM_NAME "" [get_files pcileech_vfifo.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files pcileech_vfifo.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files pcileech_vfifo.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files pcileech_vfifo.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files pcileech_vfifo.bd ] 
set_property USED_IN_SIMULATION "1" [get_files pcileech_vfifo.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files pcileech_vfifo.bd ] 
