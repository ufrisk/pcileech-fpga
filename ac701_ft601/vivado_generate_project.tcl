...
set script_file "pcileech_ac701_ft601.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/ac701_ft601_archive"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_ft601_buf.sv"]\
...
set file "src/pcileech_ft601_buf.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
