...
set project_name "pcileech_ac701_ft601"
...
set orig_proj_dir "[file normalize "$origin_dir/../../Users/vivado/projects/pcileech_ac701"]"

# Create project
create_project ${project_name} ./${project_name} -part xc7a200tfbg676-2
...
set_property -name "target_constrs_file" -value "[get_files *src/pcileech_ac701.xdc]" -objects $obj
