...
# Run from within "Vivado Tcl Shell" with command: source PCILeech_NeTV2_35T.tcl -notrace
#
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tfgg484-2 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
