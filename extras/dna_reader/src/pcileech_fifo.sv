...
module pcileech_fifo #(
    ...
    wire    [383:0]     ro;  // 扩展到 384 位以容纳 DNA (48 字节)
    reg     [239:0]     rw;
    ...
    // DNA VALUE
    assign ro[351:320]  = dna_value[31:0];              // +028: DNA[31:0] - DNA 低 32 位
    assign ro[376:352]  = dna_value[56:32];             // +02C: DNA[56:32] - DNA 高 25 位
    assign ro[377]      = dna_ready;                    // +02F: DNA_READY 标志
    assign ro[383:378]  = 0;                            //       SLACK
    // +030
