...
3) cd into the GBOX directory of the cloned or unpacked code (forward slash instead of backslash in path).
...
* Open the project in Vivado by double clicking on `pcileech_gbox.xpr` in the generated pcileech_gbox sub-folder.
* In the PROJECT MANAGER - EnigmaX1 window expand: Design Sources > pcileech_gbox_top > i_pcileech_pcie_a7x4.
