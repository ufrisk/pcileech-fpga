#
# Vivado generated .tcl for creating the pcileech_gbox vivado project.
...
set _xil_proj_name_ "pcileech_gbox"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_gbox_top.sv" ]\
]
...
set file "src/pcileech_gbox_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pcileech_gbox_top" -objects $obj
...
set file "[file normalize ${origin_dir}/src/pcileech_gbox.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "src/pcileech_gbox.xdc"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tfgg484-2 -flow {Vivado Synthesis 2023} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tfgg484-2 -flow {Vivado Implementation 2023} -strategy "Performance_ExtraTimingOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
